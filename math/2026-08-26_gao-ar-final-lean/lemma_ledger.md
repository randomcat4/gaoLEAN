...
| Standard lower bound | lower-bound section | in progress | Olson input if needed |
| Rank 2 upper bound | rank-two section | open | internal + named published inputs |
...
| Weighted structural theorem | external theorem map | interface not yet frozen | external |
