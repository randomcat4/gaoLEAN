...
| P7-L13 | invariant-factor/homocyclic numeric corollaries | PARTIAL | STRICTLY_WEAKER | ordinary 数值核由 `PGOlson.isOrdinaryDavenportConstant_invariantProduct` 给出；最终 Gao 展示式待封装 |
